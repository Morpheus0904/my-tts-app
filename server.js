...
// ================================================================
// 从环境变量读取讯飞密钥（环境变量名必须与下面完全一致）
//   - APPID      : 您的讯飞 APPID（如 40131eae）
//   - API_KEY    : 您的讯飞 APIKey
//   - APISECRET  : 您的讯飞 APISecret（注意没有下划线）
// ================================================================
const APPID = process.env.APPID;
const API_KEY = process.env.API_KEY;
const API_SECRET = process.env.APISECRET;  // ← 环境变量名是 APISECRET
...
function generateAuthUrl() {
  ...
  console.log('🔑 APISECRET (前4位):', API_SECRET ? API_SECRET.substring(0,4) : '未设置');
  console.log('🌐 WebSocket URL (前120字符):', url.substring(0, 120) + '...');
  return url;
}
