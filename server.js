...
function generateAuthUrl() {
  ...
  // 打印密钥的完整信息（便于核对）
  console.log('🔍 APPID 完整值:', APPID);
  console.log('🔍 API_KEY 完整值:', API_KEY);
  console.log('🔍 API_SECRET 完整值:', API_SECRET);

  const signatureOrigin = `host: ${TTS_HOST}\ndate: ${date}\nGET /v2/tts HTTP/1.1`;
  console.log('📝 签名原文（完整）:', signatureOrigin);
